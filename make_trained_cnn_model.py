...
def make_best_model(chosen_features: list[str]=CHOSEN_FEATURES,
    ...
    best_model = modelling.build_mags_ext_model(
        ...
        mags_layers=[
            modelling.conv1d_layers(2, 8, cnn_kernel_size, cnn_strides, cnn_padding,
                                    cnn_activation, "Conv-1-", verbose),
            modelling.pooling_layer(cnn_pooling, cnn_pool_size, cnn_pool_strides,
                                    cnn_pool_padding, "Pool-1", verbose),
            modelling.conv1d_layers(2, 16, cnn_kernel_size, cnn_strides, cnn_padding,
                                    cnn_activation, "Conv-2-", verbose),
            modelling.pooling_layer(cnn_pooling, cnn_pool_size, cnn_pool_strides,
                                    cnn_pool_padding, "Pool-2", verbose),
            modelling.conv1d_layers(2, 32, cnn_kernel_size, cnn_strides, cnn_padding,
                                    cnn_activation, "Conv-3-", verbose),
            modelling.pooling_layer(cnn_pooling, cnn_pool_size, cnn_pool_strides,
                                    cnn_pool_padding, "Pool-3", verbose),
            modelling.conv1d_layers(2, 64, cnn_kernel_size, cnn_strides, cnn_padding,
                                    cnn_activation, "Conv-4-", verbose),
            modelling.pooling_layer(cnn_pooling, cnn_pool_size, cnn_pool_strides,
                                    cnn_pool_padding, "Pool-4", verbose),
            modelling.conv1d_layers(2, 128, cnn_kernel_size, cnn_strides, cnn_padding,
                                    cnn_activation, "Conv-5-", verbose),
            modelling.pooling_layer(cnn_pooling, cnn_pool_size, cnn_pool_strides,
                                    cnn_pool_padding, "Pool-5", verbose),
            modelling.conv1d_layers(2, 256, cnn_kernel_size, cnn_strides, cnn_padding,
                                    cnn_activation, "Conv-6-", verbose),
            modelling.pooling_layer(cnn_pooling, cnn_pool_size, cnn_pool_strides,
                                    cnn_pool_padding, "Pool-6", verbose),
        ],
        dnn_layers=[

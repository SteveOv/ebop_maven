...
Steve's Notes
1) The elephant in the room here is that neither the readme nor the dat files give any units
  + LOG_R   appears to be in cm (see Table 3 on pp135) so divide by R_sun*100
  + LOG_L   appears to be in solar units - if it's in erg s^-1 (see T3 again) then we need to convert (1 J == 10^7 erg)
  + LOG_TE  appears to be in K
  + MASS    appears to be in solar units